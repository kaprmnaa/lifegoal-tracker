...
const PIN_KEY = 'financetrack-lock-pin'
const BIOMETRIC_KEY = 'financetrack-lock-biometric'
  ...
  const enableBiometric = useCallback(async () => {
    const credential = await navigator.credentials.create({
      publicKey: {
        ...
        rp: { name: 'FinanceTrack' },
        user: {
          id: crypto.getRandomValues(new Uint8Array(16)),
          name: 'financetrack-app-lock',
          displayName: 'FinanceTrack App Lock',
        },
        pubKeyCredParams: [
